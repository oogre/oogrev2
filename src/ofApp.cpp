...
void ofApp::setup()
{
    ...
    resolutionGroup->add<ofxGuiIntInputField>(res_width.set("Width",2400,10,2400), ofJson({
        {"background-color" , "transparent"}
    }));
    res_width.addListener(this, &ofApp::resolutionWidthChanged);
    resolutionGroup->add<ofxGuiIntInputField>(res_height.set("Height",800,10,800), ofJson({
        {"background-color" , "transparent"}
    }));
